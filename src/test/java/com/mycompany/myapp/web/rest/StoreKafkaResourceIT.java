...
import com.mycompany.myapp.service.StoreKafkaProducer;
import com.mycompany.myapp.service.StoreKafkaConsumer;
...
public class StoreKafkaResourceIT {
    ...
    @Autowired
    private StoreKafkaProducer producer;

    @Autowired
    private StoreKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        StoreKafkaResource kafkaResource = new StoreKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/store-kafka/publish?message=test"))
